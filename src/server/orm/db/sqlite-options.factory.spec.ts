...
describe('SERVER ORM: ORMSQLiteConnectionOptionsBuilder', () => {
  ...
  beforeEach(() => {
    ...
    const baseConnectionOptionsFactory: interfaces.FactoryCreator<ConnectionOptions> =
  ...
  it('should contain options factory', () => {
    const factory = container.getTagged<interfaces.Factory<ConnectionOptions>>(registry.ORMConnectionOptionsFactory, 'type', registry.ORMSQLiteConnectionOptionsFactory);
